  ...
  return (
    <div className="mx-[-112px] h-[calc(100vh-153px)] relative">
      <div className="absolute top-7 left-[22px] flex gap-3">
        ...
        <div
          className=" cursor-pointer z-10 flex gap-2 items-center text-[#3C3C3C] bg-[#FFC982] pl-3 pr-6 py-1.5 font-semibold rounded-[12px]"
          onClick={() => setOpenSavedList(true)}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="10"
      ...
      {openSavedList && (
        <div className="w-[392px] h-full z-15 bg-[#fff] top-0 absolute left-0 pt-[81px] pl-[22px]">
          d
        </div>
      )}
